...
function injectCss() {
  ...
  #boot .wm .tg{margin-top:9px; font-size:12.5px; letter-spacing:.42em; text-transform:uppercase; color:#8a99bd; font-weight:600;}
  ...
  boot.innerHTML =
    `<div class="grid"></div><div class="vig"></div>
     <div class="stagewrap">
       ...
       <div class="wm"><div class="nm">Controlyx<span class="yr">2026</span></div><div class="tg">Primavera&nbsp;P6&nbsp;Intelligence</div></div>
     </div>
     ...
     <div class="ver">Controlyx&nbsp;2026 · Primavera&nbsp;P6&nbsp;Intelligence</div>
