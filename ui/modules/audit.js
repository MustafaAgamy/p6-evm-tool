...
export function switchView(view) {
  ...
  document.getElementById('aireview-panel').classList.toggle('hidden', view !== 'aireview');
  ...
  document.getElementById('tab-aireview').classList.toggle('active', view === 'aireview');
