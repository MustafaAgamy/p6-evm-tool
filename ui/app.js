...
import { renderNarrativePanel }                from './modules/narrative.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.chooser-card').forEach(card =>
    card.addEventListener('click', () => {
      ...
      if (card.dataset.view === 'narrative') renderNarrativePanel();
    }));
  ...
  document.getElementById('tab-narrative').addEventListener('click', () => { switchView('narrative'); renderNarrativePanel(); });
